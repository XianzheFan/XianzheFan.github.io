...
function(t, e) {
    ...
    d.initCore = function(f) {
        ...
        ,
        d.log = function(t) {
            var e = void 0 !== i && void 0 !== i.log && void 0 !== i.log.apply, s = n.getElementById("log"), o, r, a, l, h;
            ...
            a = arguments.length; r < a; ++r) {
                if ("object" == typeof (h = arguments[r]) && void 0 !== u)
                    try {
                        h = u.stringify(h)
                    } catch (t) {}
                o += "\n" + h + "\n"
            ...
            return s ? (s.value += o + "\n-----\n",
            s.scrollTop = s.scrollHeight - s.clientHeight) : e || c(o),
            !0
        }
        ,
...
function(t, e) {
    ...
    n.measureColumns = function() {
        ...
        var n = this.columnWidth += this.gutter, s = this.containerWidth + this.gutter, o = s / n, r = n - s % n, a;
        o = Math[r && 1 > r ? "round" : "floor"](o),
        this.cols = Math.max(o, 1)
    }
    ,
    n.getContainerWidth = function() {
        var t, i = this._getOption("fitWidth") ? this.element.parentNode : this.element, n = e(i);
        this.containerWidth = n && n.innerWidth
    }
    ,
    n._getItemLayoutPosition = function(t) {
        t.getSize();
        var e = t.size.outerWidth % this.columnWidth, i, n = Math[e && 1 > e ? "round" : "ceil"](t.size.outerWidth / this.columnWidth);
        n = Math.min(n, this.cols);
        for (var s, o = this[this.options.horizontalOrder ? "_getHorizontalColPosition" : "_getTopColPosition"](n, t), r = {
            x: this.columnWidth * o.col,
            y: o.y
        }, a = o.y + t.size.outerHeight, l = n + o.col, h = o.col; l > h; h++)
            this.colYs[h] = a;
        return r
    }
    ,
    ...
    n._getHorizontalColPosition = function(t, e) {
        var i = this.horizontalColIndex % this.cols, n;
    ...
    n._manageStamp = function(t) {
        var i = e(t), n = this._getElementOffset(t), s, o = this._getOption("originLeft") ? n.left : n.right, r = o + i.outerWidth, a = Math.floor(o / this.columnWidth);
        a = Math.max(0, a);
        var l = Math.floor(r / this.columnWidth);
        l -= r % this.columnWidth ? 0 : 1,
        l = Math.min(this.cols - 1, l);
        for (var h, u = (this._getOption("originTop") ? n.top : n.bottom) + i.outerHeight, c = a; l >= c; c++)
...
function(t, e) {
    var i = t.jQuery || t.Cowboy || (t.Cowboy = {}), n;
    i.throttle = n = function(t, n, s, o) {
        function r() {
            ...
            o && !a && i(),
            a && clearTimeout(a),
            o === e && u > t ? i() : !0 !== n && (a = setTimeout(o ? r : i, o === e ? t - u : t))
        }
        var a, l = 0;
        return "boolean" != typeof n && (o = s,
        s = n,
        n = e),
        i.guid && (r.guid = s.guid = s.guid || i.guid++),
        r
    }
    ,
...
function(t, e, i, n) {
    ...
    function s(e, i) {
        ...
        t.each(t(this.element).data(), function(t, e) {
            ...
            ("" !== s || null !== s) && ("false" == e ? e = !1 : "true" == e && (e = !0),
            n[s] = e)
        }),
    ...
    t.isFunction(t.throttle) || console.warn("Fluidbox: The jQuery debounce/throttle plugin is not found/loaded. Even though Fluidbox works without it, the window resize event will fire extremely rapidly in browsers, resulting in significant degradation in performance upon viewport resize.");
    var u, c = function() {
        ...
        checkURL: function(t) {
            var e = 0;
            return /[\s+]/g.test(t) ? (console.warn("Fluidbox: Fluidbox opening is halted because it has detected characters in your URL string that need to be properly encoded/escaped. Whitespace(s) have to be escaped manually. See RFC3986 documentation."),
            e = 1) : /[\"\'\(\)]/g.test(t) && (console.warn("Fluidbox: Fluidbox opening will proceed, but it has detected characters in your URL string that need to be properly encoded/escaped. These will be escaped for you. See RFC3986 documentation."),
            e = 0),
            e
        },
    ...
    t.extend(s.prototype, {
        init: function() {
            var e = this
              , i = t(this.element)
              , n = i.find("img").first();
            if (d.measure.viewport(),
            (!e.instanceData || !e.instanceData.initialized) && i.is("a") && 1 === i.children().length && (i.children().is("img") || i.children().is("picture") && 1 === i.find("img").length) && "none" !== i.css("display") && "none" !== i.children().css("display") && "none" !== i.parents().css("display")) {
        ...
        open: function() {
            ...
            (a = new Image).onload = function() {
                if (i.trigger("imageloaddone.fluidbox"),
                1 === e.instanceData.state) {
                    if (e.instanceData.thumb.natW = a.naturalWidth,
            ...
            a.src = i.attr("href")) : ((a = new Image).onload = function() {
                return i.trigger("imageloaddone.fluidbox"),
                i.removeClass("fluidbox--loading").addClass("fluidbox--opened fluidbox--loaded").find(".fluidbox__wrap").css({
                    zIndex: e.settings.stackIndex + e.settings.stackIndexDelta
                }),
                i.trigger("openstart.fluidbox"),
                d.checkURL(a.src) ? (e.close({
                    error: !0
                }),
                !1) : (s.css({
                    "background-image": "url(" + d.formatURL(a.src) + ")"
        ...
        compute: function() {
            var e = this, i = t(this.element), n = i.find("img").first(), s = i.find(".fluidbox__ghost"), r = i.find(".fluidbox__wrap"), a = e.instanceData.thumb.natW, h = e.instanceData.thumb.natH, u = e.instanceData.thumb.w, c = e.instanceData.thumb.h, d = a / h, p = l.viewport.w / l.viewport.h, f, g, m, v, y;
            e.settings.maxWidth > 0 ? h = (a = e.settings.maxWidth) / d : e.settings.maxHeight > 0 && (a = (h = e.settings.maxHeight) * d),
            p > d ? (v = a * (c * (m = (f = h < l.viewport.h ? h : l.viewport.h * e.settings.viewportFill) / c) / h) / u,
            y = m) : (m = h * (u * (v = (g = a < l.viewport.w ? a : l.viewport.w * e.settings.viewportFill) / u) / a) / c,
            y = v),
        ...
        close: function(e) {
            ...
            return null !== i.instanceData.state && typeof i.instanceData.state != typeof n && 0 !== i.instanceData.state && (i.instanceData.state = 0,
        ...
        bindListeners: function() {
            ...
            t.isFunction(t.throttle) ? o.on("resize.fluidbox" + e.instanceData.id, t.throttle(e.settings.resizeThrottle, n)) : o.on("resize.fluidbox" + e.instanceData.id, n),
...
function(t, e, i, n) {
    ...
    s.prototype.play = function(e) {
        var i, n, s = t(e.target).closest("." + this._core.settings.itemClass), o = this._videos[s.attr("data-video")], r = o.width || "100%", a = o.height || this._core.$stage.height();
...
function(t, e, i, n) {
    ...
    s.prototype._next = function(n) {
        ...
        this._core.is("busy") || this._core.is("interacting") || i.hidden || this._core.next(n || this._core.settings.autoplaySpeed)
    }
    ,
...
function(t, e, i, n) {
    ...
    s.prototype.initialize = function() {
        ...
        i.dotsData || (this._templates = [t("<button>").addClass(i.dotClass).append(t("<span>")).prop("outerHTML")]),
...
function(t, e, i, n) {
    ...
    h() && (t.support.transform = new String(o("transform")),
...
function() {
    ...
    e.prototype.handleScroll = function() {
        ...
        for (var i in e) {
            var n = e[i], s, o = n.newScroll > n.oldScroll ? n.forward : n.backward;
            for (var r in this.waypoints[i]) {
                var a = this.waypoints[i][r];
                if (null !== a.triggerPoint) {
                    var l = n.oldScroll < a.triggerPoint, h = n.newScroll >= a.triggerPoint, u, c;
                    (l && h || !l && !h) && (a.queueTrigger(o),
    ...
    e.prototype.refresh = function() {
        ...
        t = {
            ...
            for (var a in this.waypoints[o]) {
                var l, h, u, c, d, p = this.waypoints[o][a], f = p.options.offset, g = p.triggerPoint, m = 0, v = null == g;
                ...
                d = !h && !u,
                !v && (c = h && u) ? (p.queueTrigger(r.backward),
...
function() {
    ...
    i.prototype.next = function(e) {
        ...
        var i = s.Adapter.inArray(e, this.waypoints), n;
...
function() {
    ...
    function t(t) {
        return function(i, n) {
            var s = []
              , o = i;
            return t.isFunction(i) && ((o = t.extend({}, n)).handler = i),
            this.each(function() {
                var i = t.extend({}, o, {
                    element: this
                });
...
function(t) {
    "use strict";
    function e() {
        t(".page__content").find("img:first").imagesLoaded(function() {
            t("body").removeClass("loading")
        }),
        t(".active-link").removeClass("active-link"),
        t('a[href="' + i + '"]').addClass("active-link"),
        Waypoint.destroyAll();
        var e = 0;
            ...
            i.imagesLoaded(function() {
                if ("1" === s) {
                    ...
                    var t = new Waypoint({
                        ...
                        handler: function(t) {
                            "down" === t && i.children(".gallery__wrap").trigger("stop.owl.autoplay"),
                            "up" === t && i.children(".gallery__wrap").trigger("play.owl.autoplay")
                        },
                        offset: "-100%"
                    })
                      , e = new Waypoint({
                        element: document.getElementById(n),
                        handler: function(t) {
                            "down" === t && i.children(".gallery__wrap").trigger("play.owl.autoplay"),
                            "up" === t && i.children(".gallery__wrap").trigger("stop.owl.autoplay")
                        },
                        offset: "100%"
                    })
                } else
                    i.addClass("gallery--grid"),
        ...
        t(".single p > img").each(function() {
            ...
            t(this).insertAfter(e),
            t(this).wrapAll('<div class="image-wrap"></div>'),
            e.remove()
        }),
        t(".single iframe").each(function() {
            if (t(this).attr("src").indexOf("youtube") >= 0 || t(this).attr("src").indexOf("vimeo") >= 0) {
                var e = t(this).attr("width"), i, n = t(this).attr("height") / e * 100;
    ...
    s.Adapter.bind(window, "statechange", function() {
        ...
        t(".page-loader").load(o.hash + " .page__content", function() {
            var s = 400;
            t("body, html").animate({
                scrollTop: 0
            }, 400),
            setTimeout(function() {
                t(".page .page__content").remove(),
                t(".page-loader .page__content").appendTo(".page"),
                t("body").attr("data-page-url", window.location.pathname),
                i = t("body").attr("data-page-url"),
                n = t(".page__content").attr("data-page-title"),
                document.title = n,
                e()
            }, 400)
        })
    ...
    t("body").hasClass("ajax-loading") && t(document).on("click", "a", function(e) {
        ...
        t(this).hasClass("js-no-ajax") || /^#/.test(o) || o.indexOf("mailto:") >= 0 || o.indexOf("tel:") >= 0 ? window.location = o : t(this).is(".gallery__item__link") || (o.indexOf("http") >= 0 ? window.open(o, "_blank") : (i = o,
        s.pushState(null, n, o)))
    }),
    e(),
    t(document).on("submit", "#contact-form", function(e) {
        ...
        "" === s.val() && s.closest(".contact-form__item").addClass("contact-form__item--error"),
        "" !== i.val() && "" !== n.val() && "" !== s.val() && 0 === o.val().length || e.preventDefault()
    })
}(jQuery);